...
本项目基于Rossmann连锁药店的销售数据做归因分析
项⽬地址：https://www.kaggle.com/c/rossmann-store-sales
通过多维度归因分析，找出最近三个月（2015年5月、6月、7月）营业额环比变化的主要原因及各维度/因素的贡献度。
分析结果请查看 [总结报告](summary.md)
